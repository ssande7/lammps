...
#include "compute_heat_flux_va.h"
...
ComputeHeatFluxVA::ComputeHeatFluxVA(LAMMPS *lmp, int narg, char **arg) :
...
ComputeHeatFluxVA::~ComputeHeatFluxVA()
{
...
void ComputeHeatFluxVA::init_list(int /* id */, NeighList *ptr)
{
  list = ptr;
}
...
void ComputeHeatFluxVA::compute_array()
{
...
void ComputeHeatFluxVA::compute_pairs()
