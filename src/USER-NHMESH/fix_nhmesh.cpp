...
void FixNHMesh::nhc_press_integrate()
{
  int ich,i,pdof;
...
double FixNHMesh::compute_strain_energy()
{
...
void FixNHMesh::compute_deviatoric()
{
...
void FixNHMesh::compute_press_target()
{
  double delta = update->ntimestep - update->beginstep;
  if (delta != 0.0) delta /= update->endstep - update->beginstep;
